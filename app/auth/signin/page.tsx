      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "GREIA has transformed how we manage our property portfolio and connect with clients. It's truly a game-changer."
            </p>
            <footer className="text-sm">Sofia Davis, Real Estate Professional</footer>
          </blockquote>
        </div>
      </div>
